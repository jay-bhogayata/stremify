export function PrepareEmailHtmlBody(
  OTP: string,
  OTPExpiryTimeInMinutes: number,
  verifyUserPageURL: string
): string {
  return `
            ...
            <tr style="width: 100%">
              <td>
                ...
                <p
                  ...
                  "
                >
                  This code will only be valid for the next ${OTPExpiryTimeInMinutes} minutes. If the code
                ...
                >
                  ...
                  >
                    <a href=${verifyUserPageURL} style="color: #8366ec; text-decoration: none; font-size: 14px">Verify here</a> 
                  </p>
                    <hr
                  style="
                    width: 100%;
